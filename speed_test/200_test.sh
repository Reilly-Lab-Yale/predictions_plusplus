#!/bin/bash
#SBATCH --job-name=200_mpac_test
#SBATCH --output=200_mpac_%j.out
#SBATCH --error=200_mpac_%j.out
...
output_dir="${scratch_root}/output/200_${chr_pair}"
mkdir -p $output_dir

#make a working directory for just this instance to play in...
mkdir -p "./200_${chr_pair}/chunk_${chunk}"
cd "./200_${chr_pair}/chunk_${chunk}"
