#!/bin/bash
#SBATCH --job-name=f9_14
#SBATCH --partition=gpu_h200
#SBATCH --gres=gpu:1
#SBATCH -c 2
#SBATCH --mem=60G
#SBATCH -t 1:45:00
#SBATCH --array=2,3,5,6,9,11,14,15,17,18,22,23,25,26,29,30,33,34,38,39,41,42,46,47,50,51,53,54,57,59,61,63,65,67,70,71,74,75,78,79,82,83,85,87,89,91,93,95,97,98,101,102,106,107,110,111,114,115,117,118,121,122,126,127,129,130,133,135,138,139,141,143,145,147,149,151,154,155,157,159,161,162,165,167,170,171,173,175,176,177
