#!/bin/bash
#SBATCH --job-name=fill_10_13
#SBATCH --partition=gpu_h200
#SBATCH --gres=gpu:1
#SBATCH -c 1
#SBATCH --mem=90G
#SBATCH -t 5:00:00
#SBATCH --array=1,2,6,7,10,11,13,15,17,18,21,23,25,26,29,30,34,35,37,39,41,43,45,47,50,51,53,55,57,59,61,62,69,71,73,75,77,79,85,87,89,90,93,95,105,107,109,110,113,115,117,119,122,123,130,131,133,135,138,139,141,143,146,147,149,151,153,154,157,158,165,166,170,171,173,174,176,179,181,183,185,187,189

module load miniconda
conda activate boda_cu128

chr_pair="chr10_chr13"
