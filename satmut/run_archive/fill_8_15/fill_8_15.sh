#!/bin/bash
#SBATCH --job-name=f8_15
#SBATCH --partition=gpu_h200
#SBATCH --gres=gpu:1
#SBATCH -c 2
#SBATCH --mem=60G
#SBATCH -t 2:30:00
#SBATCH --array=129,2,6,134,11,139,14,143,145,19,149,23,153,27,31,159,34,163,165,39,41,171,173,46,48,178,181,55,58,187,61,189,67,69,75,77,81,87,91,94,99,103,105,109,115,117,122,127
